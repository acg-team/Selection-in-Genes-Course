...
Before we can perform any analyses, we need to download the inout data for this tutorial. For this tutorial we will use an alignment file in PhyLip format, same as we used in the first tutorial, `primate-nt.phy`. 
